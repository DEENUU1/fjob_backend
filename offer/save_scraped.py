...
def create_addresses(addresses) -> List:
    addresses_objects = []
    if addresses:
...
def create_salary(salaries) -> List:
    salary_objects = []
    if salaries:
...
def create_employment_type(employment_type) -> List:
...
def create_work_type(work_type) -> List:
    work_type_objects = []
    if work_type:
        for wt in work_type:
...
def create_experience(experience) -> List:
    experience_objects = []
    if experience:
...
def create_offer(
    ...
    employment_type_objects = create_employment_type(employment_type)
    work_type_objects = create_work_type(work_type)
    experience_objects = create_experience(experience)
    salary_objects = create_salary(salaries)
    addresses_objects = create_addresses(addresses)
